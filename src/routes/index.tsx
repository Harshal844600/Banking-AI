  ...
  head: () => ({
    meta: [
      { title: "FinSight AI — Your wealth, architected" },
      {
        name: "description",
        content:
          "Premium AI-powered banking analytics. Upload your CSV, get a financial health score, smart category insights, and a private AI advisor.",
      },
      { property: "og:title", content: "FinSight AI — Your wealth, architected" },
      {
        property: "og:description",
        content: "Premium AI-powered banking analytics for the modern individual.",
      },
    ],
  }),
  component: Landing,
    ...
    <div className="min-h-screen bg-background text-foreground">
      <nav className="flex items-center justify-between px-8 py-6 border-b border-border">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            to="/signup"
            className="px-5 py-2.5 bg-foreground text-background text-sm font-semibold hover:bg-accent transition-colors"
          >
            Request access
          </Link>
        </div>
      ...
      <section className="px-8 pt-20 pb-12 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-16 items-end">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-md leading-relaxed mb-10">
              Advanced liquidity monitoring, intelligent expense categorisation, and a private AI
              advisor — all powered by your own transaction data.
            </p>
            <div className="flex items-center gap-4">
              <Link
                to="/signup"
                className="px-6 py-3 bg-foreground text-background text-sm font-bold tracking-wide hover:bg-accent transition-colors"
              >
                GET STARTED
              </Link>
              <Link
                to="/login"
                className="px-6 py-3 border border-foreground/15 text-sm font-bold tracking-wide hover:bg-secondary transition-colors"
              >
                LOG IN
              </Link>
            </div>
          ...
          >
            <div className="p-6 border-l-4 border-accent bg-secondary hover:shadow-lg transition-shadow">
              ...
              <div className="border-2 border-dashed border-foreground/10 px-4 py-10 flex flex-col items-center justify-center gap-3">
                ...
                <Link
                  to="/signup"
                  className="px-3 py-1 bg-foreground text-background text-[10px] font-bold tracking-wider"
                >
                  CREATE ACCOUNT
                </Link>
              </div>
            ...
            >
              <div className="p-6 bg-background border border-border rounded-md shadow-md animate-pulse-soft">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="label-eyebrow text-muted-foreground">Live preview</div>
                    <div className="font-display text-2xl font-bold">Portfolio snapshot</div>
                  </div>
                  <div className="text-3xl font-black text-accent">84</div>
                </div>
                <div className="mt-4 text-sm text-muted-foreground">
                  Subtle motion and micro-interactions improve perceived performance.
                </div>
              </div>
            </motion.div>
          </motion.div>
        ...
        <div className="bg-secondary border border-border p-8">
          <div className="flex justify-between items-end mb-12">
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                Real-time intelligence dashboard preview
              </p>
            </div>
            <div className="flex gap-2 text-xs font-bold">
              <span className="px-3 py-1 bg-background border border-border">D</span>
              <span className="px-3 py-1 bg-background border border-border text-muted-foreground">
                W
              </span>
          ...
          <div className="grid grid-cols-12 gap-6">
            <div className="col-span-12 lg:col-span-4 bg-background p-8 border border-border flex flex-col items-center justify-center relative">
              <div className="absolute top-4 left-4 label-eyebrow text-foreground/20 italic">
                Health Metric v1
              </div>
              ...
              <p className="mt-6 text-xs text-center text-muted-foreground leading-relaxed">
                Capital efficiency is 12% higher than last quarter — driven by reduced recurring
                overhead.
              </p>
            </div>
                ...
                <tbody className="divide-y divide-border">
                  {[
                    ...
                    <tr key={r.d}>
                      ...
                      <td
                        className={`py-4 px-6 text-right text-xs font-bold ${r.pos ? "text-accent" : ""}`}
                      >
                        {r.a}
                      </td>
                    </tr>
            ...
            <div className="col-span-12 lg:col-span-5 flex flex-col gap-6">
              <div className="bg-foreground text-background p-8 flex-1">
                ...
                <div className="space-y-4 mb-8">
                  <div className="bg-white/10 p-3 text-xs leading-relaxed">
                    Your tax liability for Q4 is projected at{" "}
                    <span className="text-accent font-bold">₹18,400</span>. Would you like me to
                    optimize your remaining deduction window?
                  </div>
                  <div className="text-xs opacity-50 italic">Awaiting user input…</div>
                </div>
                <div className="flex gap-2">
                  <div className="flex-1 bg-white/5 border border-white/10 px-3 py-2 text-xs text-white/40">
                    Ask about your finances…
                  </div>
                  <div className="px-4 py-2 bg-background text-foreground text-xs font-bold">
                    SEND
                  </div>
                </div>
              </div>
              <Link
                to="/signup"
                className="bg-accent text-background p-4 flex items-center justify-between hover:opacity-90 transition-opacity"
              >
                <div className="flex items-center gap-3">
                  <div className="size-8 border border-white/20 flex items-center justify-center font-bold text-xs">
                    +
                  </div>
          ...
          {[
            {
              n: "01",
              t: "Upload",
              d: "Drop a CSV from any bank or add transactions manually. We support standard date/description/amount columns.",
            },
            {
              n: "02",
              t: "Categorize",
              d: "Our AI categorizes every transaction across 10 spending classes — food, travel, utilities, investments and more.",
            },
            {
              n: "03",
              t: "Decide",
              d: "Watch your financial health score react in real-time. Ask the AI advisor anything about your spending or savings.",
            },
          ].map((s) => (
      ...
      <footer id="security" className="px-8 py-12 border-t border-border">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] font-bold tracking-[0.2em] text-muted-foreground">
          ...
          <span className="text-[11px] font-normal">
            Contact:{" "}
            <a href="mailto:harshal91@gmailcom" className="underline">
              Harshal Vidhate
            </a>
          </span>
        </div>
